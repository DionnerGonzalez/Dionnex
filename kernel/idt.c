/* ============================================================================
 * Dionnex Monolithic Kernel - Interrupt Descriptor Table (IDT) Implementation
 * ============================================================================
 */
...
void idt_init(void) {
    ...
    printk("IDT: Loaded 256 gates & remapped 8259 PIC\n");
}
